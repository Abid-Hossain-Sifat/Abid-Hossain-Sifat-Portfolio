  ...
  return (
    <section id="home" className="hero-section">
        ...
        <div className="hero-grid">
          ...
          <div className="hero-text-content"> 
            <h1 className="hero-main-title">
              <span className="title-intro reveal-item" style={{ '--d': '1' }}>I&apos;m</span>
            ...
            <p className="hero-bio reveal-item" style={{ '--d': '4' }}>
              I specialize in MERN Stack development, building <span className="highlight">scalable web applications</span> with <span className="highlight">responsive</span>, <span className="highlight">pixel-perfect interfaces</span> and user-centric digital experiences.
            </p>

            <div className="tech-stack-preview reveal-item" style={{ '--d': '5' }}>
              <span className="stack-label">Core Expertise</span>
              <div className="stack-items">
                {['React.js', 'Next.js', 'Node.js', 'Express.js', 'MongoDB'].map(tech => (
            ...
            <div className="hero-social-footer reveal-item" style={{ '--d': '7' }}>
              <span className="social-text">Find me on</span>
              <div className="social-icons">
                {socialLinks.map(link => (
                  <a key={link.id} href={link.href} target="_blank" rel="noopener noreferrer" className="social-icon-link" aria-label={link.label}>
                    {link.icon}
                  </a>
                ))}
              </div>
      ...
      <style jsx>{`
        ...
        .mesh-1 { top: -10%; right: -5%; width: 600px; height: 600px; background: var(--color-primary); }
        .mesh-2 { bottom: -10%; left: -5%; width: 500px; height: 500px; background: #a855f7; animation-delay: -5s; }
        .mesh-3 { top: 30%; left: 30%; width: 400px; height: 400px; background: #6366f1; opacity: 0.1; }
        ...
        .card-top { top: 15%; right: -80px; animation-delay: 0.5s; }
        .card-bottom { bottom: 15%; left: -80px; animation-delay: 1.5s; }

        .info-icon { font-size: 1.5rem; }
        .info-text { display: flex; flex-direction: column; }
        .info-val { font-size: 1.1rem; font-weight: 800; color: white; line-height: 1; }
        .info-lbl { font-size: 0.75rem; color: var(--color-text-muted); font-weight: 600; margin-top: 2px; }
        ...
        .ring-lg { width: 550px; height: 550px; animation: rotate 40s linear infinite; }
        .ring-md { width: 480px; height: 480px; animation: rotate 30s linear infinite reverse; opacity: 0.6; }
        .ring-sm { width: 400px; height: 400px; border-style: solid; border-width: 0.5px; opacity: 0.3; }
        ...
        @media (max-width: 1200px) {
          .hero-grid { gap: 3rem; }
          .profile-wrapper { width: 360px; height: 360px; }
        ...
        @media (max-width: 992px) {
          ...
          .role-container { justify-content: center; width: 100%; }
          .role-line { display: none; }
          .hero-bio { margin-left: auto; margin-right: auto; }
          .stack-items { justify-content: center; }
          .hero-cta-group { justify-content: center; }
          .hero-social-footer { justify-content: center; width: 100%; }
          .hero-visual-content { order: -1; margin-bottom: 2rem; }
          .profile-wrapper { width: 320px; height: 320px; }
          .card-top { right: -30px; }
          .card-bottom { left: -30px; }
        ...
        @media (max-width: 576px) {
          ...
          .role-text { font-size: 1.3rem; }
          .hero-bio { font-size: 1.05rem; }
          .hero-cta-group { flex-direction: column; width: 100%; max-width: 320px; gap: 1rem; }
          .cta-button { justify-content: center; width: 100%; }
          .profile-wrapper { width: 260px; height: 260px; }
          .glass-frame { border-radius: 40px; padding: 12px; }
          .image-holder { border-radius: 28px; }
          .floating-info { padding: 0.65rem 0.9rem; border-radius: 16px; gap: 0.5rem; }
          .card-top { right: -18px; top: 12%; }
          .card-bottom { left: -18px; bottom: 12%; }
          .info-icon { font-size: 1.1rem; }
          .info-val { font-size: 0.95rem; }
          .info-lbl { font-size: 0.65rem; }
          .stack-badge { padding: 0.4rem 0.8rem; font-size: 0.85rem; }
        }

        @media (max-width: 400px) {
          .title-name { font-size: 2.8rem; }
          .profile-wrapper { width: 220px; height: 220px; }
          .floating-info { padding: 0.6rem 0.8rem; border-radius: 14px; gap: 0.4rem; }
          .card-top { right: -12px; top: 10%; }
          .card-bottom { left: -12px; bottom: 10%; }
